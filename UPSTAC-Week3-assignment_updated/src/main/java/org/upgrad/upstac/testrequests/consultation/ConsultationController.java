...
public class ConsultationController {
    ...
    public List<TestRequest> getForDoctor() {
        ...
        // Implement this method to return the list of test requests assigned to current doctor(make use
    ...
    public TestRequest assignForConsultation(@PathVariable Long id) {
        ...
        // Implement this method to assign a particular test request to the current doctor(logged in
        // user)
        ...
        try {
            User doctor = userLoggedInService.getLoggedInUser();
            TestRequest assignId = testRequestUpdateService.assignForConsultation(id, doctor);
            return assignId;
    ...
    public TestRequest updateConsultation(
        ...
        // Implement this method to update the result of the current test request id with test doctor
        // comments
        // Create an object of the User class to get the logged in user
        // Create an object of TestRequest class and make use of updateConsultation() method from
        // testRequestUpdateService class to update the current test request id with the testResult
        // details by the current user(object created)
        // For reference check the method updateLabTest() method from LabRequestController class

        try {
            // replace this line of code with your implementation
            User doctor = userLoggedInService.getLoggedInUser();
            TestRequest result = testRequestUpdateService.updateConsultation(id, testResult, doctor);
            return result;
